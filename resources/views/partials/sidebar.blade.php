    ...
    <ul class="app-menu">
        ...
        <li class="treeview "><a class="app-menu__item {{ request()->is('category*') ? 'active' : '' }}" href="#"
            ...
            <ul class="treeview-menu">
                @can('category-create')
                <li><a class="treeview-item " href="{{ route('category.create') }}"><i class="icon fa fa-plus"></i>أضف
                        تصنيف جديد </a></li>
                @endcan
        ...
        <li class="treeview"><a class="app-menu__item {{ request()->is('product*') ? 'active' : '' }}" href="#"
            ...
            <ul class="treeview-menu">
                @can('product-create')
                <li><a class="treeview-item" href="{{ route('product.create') }}"><i class="icon fa fa-circle-o"></i>أضف
                        منتوج جديد </a></li>
                @endcan
        ...
        <li class="treeview"><a class="app-menu__item {{ request()->is('store*') ? 'active' : '' }}" href="#"
            ...
            <ul class="treeview-menu">
                @can('store-create')
                <li><a class="treeview-item" href="{{ route('store.create') }}"><i class="icon fa fa-circle-o"></i>أضف
                        مخزن جديدة</a></li>
                @endcan
        ...
        <li class="treeview"><a class="app-menu__item {{ request()->is('purchase*') ? 'active' : '' }}" href="#"
            ...
            <ul class="treeview-menu">
                ...
                @endcan
                <li><a class="treeview-item" href="{{ route('purchase.index') }}"><i class="icon fa fa-circle-o"></i>كل
                        المشتريات </a></li>
            </ul>
        </li>
        @endcan
        ...
        <li class="treeview "><a class="app-menu__item {{ request()->is('invoice*') ? 'active' : '' }}" href="#"
            ...
            <ul class="treeview-menu">
                @can('invoice-create')
                <li><a class="treeview-item " href="{{ route('invoice.create') }}"><i class="icon fa fa-plus"></i>أضف
                        فاتورة جديدة </a></li>
                @endcan
        ...
        <li class="treeview"><a class="app-menu__item {{ request()->is('supplier*') ? 'active' : '' }}" href="#"
            ...
            <ul class="treeview-menu">
                ...
                @endcan
                <li><a class="treeview-item" href="{{ route('supplier.index') }}"><i class="icon fa fa-circle-o"></i>كل
                        الموردين </a></li>
            </ul>
        </li>
        @endcan
        ...
        <li class="treeview"><a class="app-menu__item {{ request()->is('user*') ? 'active' : '' }}"
                                href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-users"></i><span
                    class="app-menu__label">المستخدمين</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                @can('user-create')
