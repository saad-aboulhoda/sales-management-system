...
@section('content')
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-edit"></i> تعديل مستخدم</h1>
            </div>
                    ...
                    <form action="{{ route('user.update', $user->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <input value="{{ $user->f_name }}" name="f_name" class="form-control @error('f_name') is-invalid @enderror" id="Inputfname"
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input value="{{ $user->l_name }}" name="l_name" class="form-control @error('l_name') is-invalid @enderror" id="Inputlname"
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input value="{{ $user->email }}" name="email" class="form-control @error('email') is-invalid @enderror" id="InputEmail1"
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input value="{{ $user->mobile }}" name="mobile" class="form-control @error('mobile') is-invalid @enderror" id="InputMobile"
