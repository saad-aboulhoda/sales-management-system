...
@section('content')
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-edit"></i> إضافة مورد</h1>
            </div>
        ...
        <div>
            <a class="btn btn-primary" href="{{ route('supplier.index') }}"><i class="fa fa-edit"></i> إدارة
                الموردين</a>
        </div>
        <div class="row mt-2">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input name="name" class="form-control @error('name') is-invalid @enderror"
                                           type="text" placeholder="أدخل اسم المورد">
                                    @error('name')
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input name="mobile" class="form-control @error('mobile') is-invalid @enderror"
                                           type="text" placeholder="أدخل رقم هاتف المورد">
                                    @error('mobile')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
